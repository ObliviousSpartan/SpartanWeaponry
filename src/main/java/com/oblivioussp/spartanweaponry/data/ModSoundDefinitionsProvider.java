...
public class ModSoundDefinitionsProvider extends SoundDefinitionsProvider 
{
	...
	{
		add(ModSounds.THROWN_WEAPON_THROW, SoundDefinition.definition().subtitle("subtitle.spartanweaponry.thrown_weapon_throw").
		...
		add(ModSounds.THROWN_WEAPON_HIT_GROUND, SoundDefinition.definition().subtitle("subtitle.spartanweaponry.thrown_weapon_hit_ground").
		...
		add(ModSounds.OIL_APPLIED, SoundDefinition.definition().subtitle("subtitle.spartanweaponry.oil_applied").
				with(Sound.sound(new ResourceLocation("block/brewing_stand/brew1"), SoundType.SOUND),
					Sound.sound(new ResourceLocation("block/brewing_stand/brew2"), SoundType.SOUND)));
		
		add(ModSounds.HAMMER_SLAMS_INTO_GROUND, SoundDefinition.definition().subtitle("subtitle.spartanweaponry.hammer_slams_into_ground").
				with(Sound.sound(new ResourceLocation("random/explode1"), SoundType.SOUND),
