...
public class MediumArrowQuiverModel extends QuiverModelBase
{
	...
	public MediumArrowQuiverModel(ModelPart rootModel) 
	{
		super(rootModel);
	...
	public static LayerDefinition createLayer()
	{
		...
		part.addOrReplaceChild(PART_QUIVER, CubeListBuilder.create().texOffs(0, 0).addBox(-2.5f, -4.0f, 3.0f, 5.0f, 8.0f, 4.0f), PartPose.offsetAndRotation(0.0f, 4.5f, 0.0f, 0.0f, 0.0f, -0.5235987755982988f));
		...
		part.addOrReplaceChild(PART_ARROW_1_PART_1, CubeListBuilder.create().texOffs(26, 0).addBox(-6.3f, -10.0f, 3.2f, 3.0f, 6.0f, 0.0f), PartPose.offsetAndRotation(0.0f, 4.5f, 0.0f, 0.0f, 0.7853981633974483f, -0.5235987755982988f));		
		part.addOrReplaceChild(PART_ARROW_1_PART_2, CubeListBuilder.create().texOffs(26, 0).addBox(1.7f, -10.0f, 4.8f, 3.0f, 6.0f, 0.0f), PartPose.offsetAndRotation(0.0f, 4.5f, 0.0f, 0.0f, -0.7853981633974483f, -0.5235987755982988f));	
		part.addOrReplaceChild(PART_ARROW_2_PART_1, CubeListBuilder.create().texOffs(26, 0).addBox(-4.8f, -10.0f, 4.8f, 3.0f, 6.0f, 0.0f), PartPose.offsetAndRotation(0.0f, 4.5f, 0.0f, 0.0f, 0.7853981633974483f, -0.5235987755982988f));		
		part.addOrReplaceChild(PART_ARROW_2_PART_2, CubeListBuilder.create().texOffs(26, 0).addBox(3.3f, -10.0f, 3.3f, 3.0f, 6.0f, 0.0f), PartPose.offsetAndRotation(0.0f, 4.5f, 0.0f, 0.0f, -0.7853981633974483f, -0.5235987755982988f));	
