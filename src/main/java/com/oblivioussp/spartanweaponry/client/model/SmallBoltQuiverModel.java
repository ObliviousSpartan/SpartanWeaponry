...
/* public ModelRenderer quiver;
	...
	public SmallBoltQuiverModel(ModelPart modelParts) 
	{
		super(modelParts);
	...
	public static LayerDefinition createLayer()
	{
		...
		part.addOrReplaceChild(PART_QUIVER, CubeListBuilder.create().texOffs(0, 0).addBox(-2.0f, -3.0f, 3.0f, 4.0f, 5.0f, 4.0f), PartPose.offsetAndRotation(0.0f, 4.5f, 0.0f, 0.0f, 0.0f, -0.5235987755982988f));
		...
		part.addOrReplaceChild(PART_ARROW_1_PART_1, CubeListBuilder.create().texOffs(26, 0).addBox(-6.1f, -8.0f, 3.3f, 3.0f, 5.0f, 0.0f), PartPose.offsetAndRotation(0.0f, 4.5f, 0.0f, 0.0f, 0.7853981633974483f, -0.5235987755982988f));		
		part.addOrReplaceChild(PART_ARROW_1_PART_2, CubeListBuilder.create().texOffs(26, 0).addBox(1.8f, -8.0f, 4.6f, 3.0f, 5.0f, 0.0f), PartPose.offsetAndRotation(0.0f, 4.5f, 0.0f, 0.0f, -0.7853981633974483f, -0.5235987755982988f));	
		part.addOrReplaceChild(PART_ARROW_2_PART_1, CubeListBuilder.create().texOffs(26, 0).addBox(-4.7f, -8.0f, 4.7f, 3.0f, 5.0f, 0.0f), PartPose.offsetAndRotation(0.0f, 4.5f, 0.0f, 0.0f, 0.7853981633974483f, -0.5235987755982988f));		
		part.addOrReplaceChild(PART_ARROW_2_PART_2, CubeListBuilder.create().texOffs(26, 0).addBox(3.2f, -8.0f, 3.2f, 3.0f, 5.0f, 0.0f), PartPose.offsetAndRotation(0.0f, 4.5f, 0.0f, 0.0f, -0.7853981633974483f, -0.5235987755982988f));	
        ...
        this.arrow_1_1.addBox(-6.1F, -8.0F, 3.3F, 3.0F, 5.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.arrow_1_2.addBox(1.8F, -8.0F, 4.6F, 3.0F, 5.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(arrow_1_2, 0.0F, -0.7853981633974483F, -0.5235987755982988F);
        this.arrow_2_1 = new ModelRenderer(this, 26, 0);
        this.arrow_2_1.setRotationPoint(0.0F, 5.0F, 0.0F);
        this.arrow_2_1.addBox(-4.7F, -8.0F, 4.7F, 3.0F, 5.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(arrow_2_1, 0.0F, 0.7853981633974483F, -0.5235987755982988F);
        this.arrow_2_2 = new ModelRenderer(this, 26, 0);
        this.arrow_2_2.setRotationPoint(0.0F, 5.0F, 0.0F);
        this.arrow_2_2.addBox(3.2F, -8.0F, 3.2F, 3.0F, 5.0F, 0.0F, 0.0F, 0.0F, 0.0F);
    ...
    /*public LightBoltQuiverModel() 
    {
		this.textureWidth = 32;
        this.textureHeight = 32;
        this.quiver = new ModelRenderer(this, 0, 0);
        this.quiver.setRotationPoint(0.0F, 5.0F, 0.0F);
        this.quiver.addBox(-2.0F, -3.0F, 3.0F, 4.0F, 5.0F, 4.0F, 0.0F, 0.0F, 0.0F);
