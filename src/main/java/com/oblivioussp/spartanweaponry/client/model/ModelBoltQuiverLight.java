...
/**
 * ModelQuiverLight - ObliviousSpartan
 * Created using Tabula 7.0.0; Also edited manually by ObliviousSpartan
 */
public class ModelBoltQuiverLight extends ModelQuiverBase 
{
	...
	public ModelBoltQuiverLight() 
    {
        ...
        this.arrow_1_2.addBox(3.25F, -9.0F, 6.1F, 3, 6, 0, 0.0F);
	...
	public void render(float scale)
	{
        ...
        /*GlStateManager.translate(this.arrow_1.offsetX, this.arrow_1.offsetY, this.arrow_1.offsetZ);
        GlStateManager.translate(this.arrow_1.rotationPointX * scale, this.arrow_1.rotationPointY * scale, this.arrow_1.rotationPointZ * scale);
        GlStateManager.scale(0.5D, 0.5D, 0.4D);
        GlStateManager.translate(-this.arrow_1.offsetX, -this.arrow_1.offsetY, -this.arrow_1.offsetZ);
        GlStateManager.translate(-this.arrow_1.rotationPointX * scale, -this.arrow_1.rotationPointY * scale, -this.arrow_1.rotationPointZ * scale);
        this.arrow_1.render(scale);
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.arrow_2.offsetX, this.arrow_2.offsetY, this.arrow_2.offsetZ);
        GlStateManager.translate(this.arrow_2.rotationPointX * scale, this.arrow_2.rotationPointY * scale, this.arrow_2.rotationPointZ * scale);
        GlStateManager.scale(0.5D, 0.5D, 0.4D);
        GlStateManager.translate(-this.arrow_2.offsetX, -this.arrow_2.offsetY, -this.arrow_2.offsetZ);
        GlStateManager.translate(-this.arrow_2.rotationPointX * scale, -this.arrow_2.rotationPointY * scale, -this.arrow_2.rotationPointZ * scale);
        this.arrow_2.render(scale);*/
	...
	protected void renderArrows(float scale)
	{
		...
		if(arrowsToRender >= 1)
		{
	        ...
	        this.arrow_1_2 = new ModelRenderer(this, 26, 0);
	        this.arrow_1_2.setRotationPoint(0.0F, 0.0F, 0.0F);
	        this.arrow_1_2.addBox(3.25F, -11.0F, 6.1F, 3, 6, 0, 0.0F);
	        this.setRotateAngle(arrow_1_2, 0.0F, -0.7853981633974483F, -0.5235987755982988F);*/
	        GlStateManager.pushMatrix();
	        ...
	        GlStateManager.scale(0.75D, 0.75D, 0.74D);
	        GlStateManager.translate(-this.arrow_1_2.offsetX, -this.arrow_1_2.offsetY, -this.arrow_1_2.offsetZ);
	        GlStateManager.translate(-this.arrow_1_2.rotationPointX * scale, -this.arrow_1_2.rotationPointY * scale, -this.arrow_1_2.rotationPointZ * scale);
		...
		if(arrowsToRender >= 2)
		{
	        /*this.arrow_2_1 = new ModelRenderer(this, 26, 0);
	        this.arrow_2_1.setRotationPoint(0.0F, 0.0F, 0.0F);
	        this.arrow_2_1.addBox(-11.0F, -11.0F, 11.0F, 3, 6, 0, 0.0F);
	        this.setRotateAngle(arrow_2_1, 0.0F, 0.7853981633974483F, -0.5235987755982988F);
	        this.arrow_2_2 = new ModelRenderer(this, 26, 0);
	        this.arrow_2_2.setRotationPoint(0.0F, 0.0F, 0.0F);
	        this.arrow_2_2.addBox(9.5F, -11.0F, 9.5F, 3, 6, 0, 0.0F);
	        this.setRotateAngle(arrow_2_2, 0.0F, -0.7853981633974483F, -0.5235987755982988F);*/
			GlStateManager.pushMatrix();
		...
		if(arrowsToRender >= 3)
		{
	        /*this.arrow_3_1 = new ModelRenderer(this, 26, 0);
	        this.arrow_3_1.setRotationPoint(0.0F, 0.0F, 0.0F);
	        this.arrow_3_1.addBox(-9.5F, -11.0F, 8.0F, 3, 6, 0, 0.0F);
	        this.setRotateAngle(arrow_3_1, 0.0F, 0.7853981633974483F, -0.5235987755982988F);
	        this.arrow_3_2 = new ModelRenderer(this, 26, 0);
	        this.arrow_3_2.setRotationPoint(0.0F, 0.0F, 0.0F);
	        this.arrow_3_2.addBox(6.5F, -11.0F, 8.0F, 3, 6, 0, 0.0F);
	        this.setRotateAngle(arrow_3_2, 0.0F, -0.7853981633974483F, -0.5235987755982988F);*/
			GlStateManager.pushMatrix();
