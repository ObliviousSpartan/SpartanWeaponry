...
public class MediumBoltQuiverModel extends QuiverModelBase
{
    ...
    public MediumBoltQuiverModel() 
    {
        ...
        quiver.setRotationPoint(0.0F, 4.8F, 0.0F);
        quiver.addBox(-2.5F, -3.0F, 3.0F, 5.0F, 5.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        setRotateAngle(quiver, 0.0F, 0.0F, -0.5235987755982988F);
        strap_front = new ModelRenderer(this, 0, 16);
        strap_front.setRotationPoint(0.0F, 4.8F, 0.0F);
        ...
        strap_top.setRotationPoint(0.0F, 4.8F, 0.0F);
        ...
        strap_back.setRotationPoint(0.0F, 4.8F, 0.0F);
        ...
        strap_bottom.setRotationPoint(0.0F, 4.8F, 0.0F);
        ...
        arrow_1_1.setRotationPoint(0.0F, 5.0F, 0.0F);
        arrow_1_1.addBox(-6.3F, -8.0F, 3.2F, 3.0F, 5.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        setRotateAngle(arrow_1_1, 0.0F, 0.7853981633974483F, -0.5235987755982988F);
        arrow_1_2 = new ModelRenderer(this, 26, 0);
        arrow_1_2.setRotationPoint(0.0F, 5.0F, 0.0F);
        arrow_1_2.addBox(1.7F, -8.0F, 4.8F, 3.0F, 5.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        setRotateAngle(arrow_1_2, 0.0F, -0.7853981633974483F, -0.5235987755982988F);
        arrow_2_1 = new ModelRenderer(this, 26, 0);
        arrow_2_1.setRotationPoint(0.0F, 4.8F, 0.0F);
        arrow_2_1.addBox(-4.8F, -8.0F, 4.8F, 3.0F, 5.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        setRotateAngle(arrow_2_1, 0.0F, 0.7853981633974483F, -0.5235987755982988F);
        arrow_2_2 = new ModelRenderer(this, 26, 0);
        arrow_2_2.setRotationPoint(0.0F, 4.8F, 0.0F);
        arrow_2_2.addBox(3.3F, -8.0F, 3.3F, 3.0F, 5.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        setRotateAngle(arrow_2_2, 0.0F, -0.7853981633974483F, -0.5235987755982988F);
        arrow_3_1 = new ModelRenderer(this, 26, 0);
        arrow_3_1.setRotationPoint(0.0F, 5.0F, 0.0F);
        arrow_3_1.addBox(-4.5F, -8.0F, 3.0F, 3.0F, 5.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        setRotateAngle(arrow_3_1, 0.0F, 0.7853981633974483F, -0.5235987755982988F);
        arrow_3_2 = new ModelRenderer(this, 26, 0);
        arrow_3_2.setRotationPoint(0.0F, 5.0F, 0.0F);
        arrow_3_2.addBox(1.5F, -8.0F, 3.0F, 3.0F, 5.0F, 0.0F, 0.0F, 0.0F, 0.0F);
