...
public class APIConstants
{
	...
	public static final float DefaultMaterialDamageInvar = 2.25f;
	public static final float DefaultMaterialDamageConstantan = 2.25f;
	public static final float DefaultMaterialDamagePlatinum = 3.5f;
	public static final float DefaultMaterialDamageAluminum = 2.125f;
	...
	public static final int DefaultMaterialDurabilityConstantan = 300;
	public static final int DefaultMaterialDurabilityPlatinum = 1024;
	public static final int DefaultMaterialDurabilityAluminum = 400;
}
